...
angular.module('akat-form-creator').directive('elemdatetimepicker', ['$timeout', function ($timeout) {
    return {
        ...
        link: function link($scope, element) {
            ...
            if (!$scope.model && _.get($scope, 'options.default.value', false)) {
...
angular.module('akat-form-creator').directive('elemradio', ['$http', '$log', function ($http, $log) {
    return {
        ...
        link: function link($scope) {
            ...
            $scope.key = {
                value: _.get($scope, 'options.http.value', 'value'),
                text: _.get($scope, 'options.http.text', 'text')
            };

            if (_.get($scope, 'options.http', false)) {
                $http($scope.options.http).then(function (res) {
...
angular.module('akat-form-creator').directive('elemselectbox', ['$http', '$q', function ($http, $q) {
    return {
...
angular.module('akat-form-creator').directive('elemtags', ['$http', '$q', function ($http, $q) {
    return {
        ...
        link: function link($scope, element) {
            ...
            if (_.get($scope, 'options.http', false)) {
                var text = _.get($scope, 'options.http.text', false);
...
angular.module('akat-form-creator').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('submodules/akat-form-creator/elements/datepicker/datepicker.html',
    ...
    "                        data-ng-readonly=\"options.readonly\"\n" +
  ...
  $templateCache.put('submodules/akat-form-creator/elements/tags/tags.html',
    ...
    "                    data-ng-model=\"model\"\n" +
    "                    \n" +
    "                    data-ng-attr-min-tags=\"{{ options.validators.minlength }}\"\n" +
    "                    data-ng-attr-max-tags=\"{{ options.validators.maxlength }}\"\n" +
    "                    data-ng-attr-allow-leftover-text=\"{{ options.allowLeftOverText }}\"\n" +
    "                    data-ng-required=\"options.required\"\n" +
    "                    data-ng-readonly=\"options.readonly\"\n" +
    "                    data-ng-disabled=\"options.disabled\"\n" +
    "                >\n" +
