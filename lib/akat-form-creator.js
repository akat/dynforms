...
angular.module('akat-form-creator').directive('elemrichtext', ['textAngularManager', 'taSelection', '$uibModal', '$log', function (textAngularManager, taSelection, $uibModal, $log) {
    return {
